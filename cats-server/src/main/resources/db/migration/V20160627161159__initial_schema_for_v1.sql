...
/* Created on:     6/27/2016 4:33:50 PM                         */
/*==============================================================*/
...
create table bid_plan (
  ...
  description          char(1)              null,
  constraint pk_bid_plan primary key (plan_id)
);
...
create table bid_plan_line_item (
  detail_line_id       serial not null,
  plan_id              int4                 null,
  destination_         int4                 null,
  source_store_id      int4                 null,
  quantity             int4                 null,
  constraint pk_bid_plan_line_item primary key (detail_line_id)
);
...
/*==============================================================*/
/* Table: commodity_batch                                       */
/*==============================================================*/
create table commodity_batch (
  id                   serial not null,
  name                 varchar(200)         not null,
  commodity_id         int4                 not null,
  internal_reference   varchar(200)         null,
  owner_id             int4                 null,
  constraint pk_commodity_batch primary key (id)
);
...
create table commodity_source (
  commodity_source_id  serial not null,
  name                 varchar(200)         null,
  description          char(1)              null,
  code                 varchar(10)          null,
  constraint pk_commodity_source primary key (commodity_source_id)
);
...
create table dispatch_allocation (
  dispatch_allocation_id varchar(36)          not null,
  hub_id               int4                 null,
  ...
  uom_id               int4                 null,
  fdp_id               int4                 null,
  constraint pk_dispatch_allocation primary key (dispatch_allocation_id)
);
...
/* Table: receive_plan                                          */
/*==============================================================*/
create table receive_plan (
  receive_plan_id      int4                 not null,
  batch_id             int4                 null,
  commodity_source_id  int4                 null,
  description          char(1)              null,
  ...
  status               int4                 null,
  date                 date                 null,
  constraint pk_receive_plan primary key (receive_plan_id)
);

/*==============================================================*/
/* Table: receive_plan_allocation                               */
/*==============================================================*/
create table receive_plan_allocation (
  receive_plan_allocation_id serial not null,
  receive_plan_id      int4                 null,
  hub_id               int4                 null,
  store_location_id    int4                 null,
  allocated_amount     decimal              null,
  constraint pk_receive_plan_allocation primary key (receive_plan_allocation_id)
);
...
create table transporter_address (
  transporter_address_id serial not null,
  transporter_id       int4                 null,
  region               int4                 null,
  zone                 int4                 null,
  ...
  constraint pk_transporter_address primary key (transporter_address_id)
);
...
create table uom_category (
  uom_category_id      serial not null,
  name                 varchar(200)         null,
  constraint pk_uom_category primary key (uom_category_id)
);
...
references commodity_type (commodity_type_id);

alter table commodity_batch
...
alter table dispatch_item
  add constraint fk_dispatch_reference_commodit foreign key (batch_id)
references commodity_batch (id);
...
alter table receipt_line
  add constraint fk_receipt__reference_commodit foreign key (batch_id)
references commodity_batch (id);
...
alter table receive_plan
  add constraint fk_receive__reference_commodit foreign key (commodity_source_id)
references commodity_source (commodity_source_id);

alter table receive_plan
  add constraint fk_receive__ref_recei_commodit foreign key (batch_id)
references commodity_batch (id);

alter table receive_plan_allocation
  add constraint fk_receive__reference_receive_ foreign key (receive_plan_id)
references receive_plan (receive_plan_id);
...
alter table stock_move
  add constraint fk_stock_mo_ref_stkmv_commodit foreign key (batch_id)
references commodity_batch (id);
...
references uom_category (uom_category_id);
...
alter table stock_transaction
  add constraint fk_stock_tr_ref_batch_commodit foreign key (batch_id)
references commodity_batch (id);
